...
def seed_menus():
    ...
    menu_items = [
    {
        ...
        "is_available": True,
        "image_url": "https://res.cloudinary.com/djuzk5um3/image/upload/v1732042436/burger_image_avvjui.jpg"
    },
    {
        "restaurant_id": 1,
        "name": "Combo Meal",
        "description": "Family Meal, at a Family value! 5x Double Cheeseburger! 2x Single Cheeseburger! With 2 Set of Fries, and drinks!",
        "price": 4,
        "category": "Family Size",
        "is_available": True,
        "image_url": "https://res.cloudinary.com/djuzk5um3/image/upload/v1732042432/combo_image_eumoso.jpg"
    },
    {
        "restaurant_id": 1,
        "name": "Animal Style Fries",
        "description": "Crispy. Crunchy. Cheesy Fries!!",
        "price": 1,
        "category": "Sides",
        "is_available": True,
        "image_url": "https://res.cloudinary.com/djuzk5um3/image/upload/v1732042426/fries_image_kcnmjr.jpg"
    },
    {
        "restaurant_id": 1,
        "name": "Dr. Pepper",
        "description": "Dr Pepper a choice thats loved by everyone!",
        "price": 0,
        "category": "Beverages",
        "is_available": True,
    ...
    },
    {
        "restaurant_id": 2,
        "name": "Plywood",
        "description": "Strong Durable Plywood!!",
        "price": 12,
        "category": "Material",
        "is_available": True,
    ...
    },
    {
        ...
        "description": "This drill can deliver a whopping 500 in/lb of torque!",
        "price": 211,
        "category": "Equipment",
        "is_available": True,
    ...
    },
    {
        ...
        "description": "Designed to withstand commercial and residential jobs.",
        "price": 20,
        "category": "Equipment",
        "is_available": True,
    ...
    },
    {
        ...
        "description": "Crowbar amazing tool!",
        "price": 13,
        "category": "Equipment",
        "is_available": True,
